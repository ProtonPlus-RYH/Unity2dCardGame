...
function Resolve()
effectList:PayCost()
local buffLastList={CS.BuffLast.actionLast,CS.BuffLast.turnLast_opponent}
...
effectList:GiveBuff(CS.SolveTarget.self,CS.EffectTarget.duelist,CS.EffectType.moveBeforeAttack,-1,buffLastList,lastReferenceList,false)
end